// International calling codes, keyed by the exact country name strings used
// in shared/deps.js's `countries` list, so the phone country-code selector
// on the provider profile-setup screen can default from the country already
// chosen earlier in onboarding.
export const DIAL_CODES = {
  ...
  'Grenada':'+1','Guatemala':'+502','Guinea':'+224','Guyana':'+592','Haiti':'+509',
  ...
  'Samoa':'+685','San Marino':'+378','Saudi Arabia':'+966','Senegal':'+221','Serbia':'+381',
...
export const DIAL_CODE_LIST = [...new Set(Object.values(DIAL_CODES))].sort((a, b) => Number(a.slice(1)) - Number(b.slice(1)));
